...
const helper = {
  ...
  buildCSS({foreground, background, ansiColors}) {
    var context = `atom-panel.tool-panel.panel-bottom.bottom .terminal-resizer.tool-panel .terminal.xterm`

    var css = `${context} {color: ${foreground}; background-color: ${background}}\
               ${context} .xterm-rows, ${context} .xterm-viewport {background-color: ${background}}\n`;
