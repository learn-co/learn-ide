var ipc = require('ipc');
var url = require('url');
//var AtomEnvironment = require('./atom-environment');
//var ApplicationDelegate = require('./application-delegate');

module.exports = function(x){
   //console.log('State and url',x.blobStore);
   //ipc.send('call-window-method', 'show');
   //ipc.send('call-window-method', 'focus');

   //var data = x.blobStore
   //console.log('Data mf::', data.getDump());
