...
class TerminalView extends View {
  ...
  loadPopoutEmulator() {
    return new Promise((resolve) => {
      ...
      localStorage.set('popout-emulator:xterm-css', fs.readFileSync(`${app.getAppPath()}/node_modules/xterm/dist/xterm.css`))
      localStorage.set('popout-emulator:fullscreen-css', fs.readFileSync(`${app.getAppPath()}/node_modules/xterm/dist/addons/fullscreen/fullscreen.css`))
