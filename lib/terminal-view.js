...
class TerminalView extends View {
  ...
  loadPopoutEmulator() {
    return new Promise((resolve) => {
      ...
      this.popout = new BrowserWindow({show: false, title: 'Learn IDE'});
  ...
  restoreEmulatorSize() {
    ...
    var storedProperties = JSON.parse(localStorage.get('learn-ide:currentEmulator'))
