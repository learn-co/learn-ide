...
class TerminalView extends View {
  ...
  subscribe() {
    ...
    this.emulator.attachCustomKeydownHandler(e => {
      return this.ignoreArrowKeyScrollCommands(e);
    })
  ...
  ignoreArrowKeyScrollCommands(e) {
    var {which, ctrlKey, metaKey} = e;

    var isCtrlOrCmd = metaKey || ctrlKey;
    var isUpOrDown = (which === 38) || (which === 40)

    if (isCtrlOrCmd && isUpOrDown) {
      e.preventDefault()
      return false
    }
  }
